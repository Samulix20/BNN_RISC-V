...
#define MATCH_SETSEED 0xB
#define MASK_SETSEED 0xFE007FFF
#define MATCH_GENUM 0x100B
#define MASK_GENUM 0xFFFFF07F
#endif /* RISCV_ENCODING_H */
#ifdef DECLARE_INSN
/* Custom instruction declaratio */
DECLARE_INSN(setseed, MATCH_SETSEED, MASK_SETSEED)
DECLARE_INSN(genum, MATCH_GENUM, MASK_GENUM)
/**/
